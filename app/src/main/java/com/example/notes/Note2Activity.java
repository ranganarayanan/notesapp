...
//              startActivity(new Intent(Notespage.this,Loginpage.class));
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if(requestCode==3){
            ...
            noteModelList.set(updatePosition,new NoteModel(ntitle, nmessage, date, date.split(" ")[0] + " " + time));
            filterList.clear();
            filterList.addAll(noteModelList);
            adapter.notifyDataSetChanged();
        }
    ...
    public void updateItem(int position) {
        ...
        Bundle b=new Bundle();
        b.putSerializable("data",noteModelList.get(updatePosition));
        Intent i=new Intent(Note2Activity.this,Notestakepage.class);
        i.putExtras(b);
